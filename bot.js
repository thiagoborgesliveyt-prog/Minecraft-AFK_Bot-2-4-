...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'eclipse-latam.aternos.me:', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 28227,                // Puerto predeterminado de Minecraft
        username: 'Eclipse',    // Nombre genérico del bot/NPC dentro del juego
    ...
    bot.on('spawn', () => {
        ...
        // setTimeout(() => bot.chat('/register thiagoxd thiagoxd'), 4000);
    });
